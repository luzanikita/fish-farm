...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/nigi4/fish-farm/controllers:LoginController"] = append(beego.GlobalControllerRouter["github.com/nigi4/fish-farm/controllers:LoginController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
