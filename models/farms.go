...
type Farms struct {
	...
	CreationDate time.Time `orm:"column(creation_date);type(date)"`
...
// AddFarms insert a new Farms into database and returns
...
// GetFarmsById retrieves Farms by Id. Returns error if
// Id doesn't exist
...
// GetAllFarms retrieves all Farms matches certain condition. Returns empty list if
// no records exist
...
// UpdateFarms updates Farms by Id and returns error if
...
// DeleteFarms deletes Farms by Id and returns error if
